...
(function () {
  ...
  // Hoisted to outer scope so injectTargetButtons can scope its querySelectorAll to the
  // same root, avoiding a full-document scan on every inject call.
  const injectRoot = document.getElementById("mainContainer")
    || document.getElementById("torn-app")
    || document.querySelector('[class*="mainContainer"]')
    || document.body;
